...
const AppConfig = {
  ...
  AGORA: {
    ...
    LIVE_SESSION_TOKEN_EXPIRATION: Number(
      process.env.APP_AGORA_LIVE_SESSION_TOKEN_EXPIRATION,
    ),
  },
  MAIL: {
    HOST: process.env.APP_MAIL_HOST,
    PORT: Number(process.env.APP_MAIL_PORT),
    USER: process.env.APP_MAIL_USER,
    PASS: process.env.APP_MAIL_PASS,
    SECURE: Boolean(process.env.APP_MAIL_SECURE),
    FROM_EMAIL: process.env.APP_MAIL_FROM_EMAIL,
  },
};
